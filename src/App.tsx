...
const TEXTS = {
  he: {
    ...
    bank_name: "בנק",
    mortgage_track: "מסלול משכנתא",
    calculation_method: "שיטת חישוב",
    spitzer: "לוח שפיצר",
    equal_principal: "קרן שווה",
    prime_spread: "תוספת / הפחתה מריבית הפריים (%)",
  ...
  en: {
    ...
    bank_name: "Bank",
    mortgage_track: "Mortgage Track",
    calculation_method: "Calculation Method",
    spitzer: "Spitzer Table",
    equal_principal: "Equal Principal",
    prime_spread: "Prime Rate Spread (+/- %)",
